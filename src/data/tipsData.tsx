...
export const tipsData: TipCategory[] = [
    ...
    content: (
      <>
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          <h3 className="text-lg text-[#ffeff8]">✨ Le système de tiers ✨</h3>
        ...
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <p className="text-[#ffeff8] mt-2">
            Les équipements dans Albion peuvent être enchantés, ce qui augmente
            leur puissance. Ces enchantements sont représentés par des nombres
            et des couleurs.
          </p>
          <ul className="list-disc list-inside text-[#ffeff8]">
        ...
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <p className="text-[#ffeff8] mt-2">
            ...
            jeu. Plus l'IP est élevé, plus vos armes et armures seront efficaces
            en combat.
          </p>
        ...
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <ul className="list-inside text-[#ffeff8]">
            ...
            <li>
              🔴 Zones Rouges : PvP complet, perte de loot possible, ressources
              avancées (T4-T7).
            </li>
            <li>
      ...
      <>
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <p className="text-[#ffeff8] mt-2">
            ...
            métiers de collecte. Cela vous permettra de mieux progresser à long
            terme, car les armes et armures peuvent être obtenues plus
        ...
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <p className="text-[#ffeff8] mt-2">
            ...
            obtenir des bonus considérables (comme les salades pour le craft ou
            les tourtes pour la collecte). De plus, les outils avaloniens vous
            donnent plus de matériaux, ce qui est une excellente façon de gagner
            de la renommée et de monter vos niveaux.
          </p>
        </div>
        ...
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <p className="text-[#ffeff8] mt-2">
            Et pour ceux qui veulent farmer les loots Twitch, je vous conseille
            le Twitch Drop Miner, un outil pratique pour récolter sans ouvrir un
            navigateur :{" "}
            <a
          ...
          <p className="text-[#ffeff8] mt-2">
            Si vous avez déjà vu un compteur de DPS ou que vous êtes intéréssés
            pour voir vos stats comme votre fame/h ou vos dégats, il existe cet
            add-on :{" "}
            <a
    ...
    content: (
      <>
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <p className="text-[#ffeff8] mt-2">
            La répartition des ressources dans les différentes capitales se fait
            ainsi :
          </p>
  ...
  {
    title: "🔥 La vie de bandit à Caerleon 🔥",
    content: (
      <div className="bg-[#656874] rounded-lg p-4 mb-4 text-[#ffeff8] space-y-4">
        <p>
          Caerleon est une faction de sauvages unique : tu peux y attaquer et te
          faire attaquer par absolument tout le monde que ce soit les autres
          factions ou même les joueurs de ta propre faction. Il n’y a aucune
          règle, c’est chacun pour soi.
        </p>
        <p>
          Ce mode de jeu se déroule uniquement en{" "}
          <strong>zones léthales</strong> (zones rouges). La mort entraîne la
          perte de tout ton équipement, donc l’organisation est cruciale. Il est
          vivement conseillé de rejoindre un <strong>Discord dédié</strong> pour
          jouer en groupe, Amaroke peut vous inviter sur un Discord fiable.
        </p>
        <p>
          Même si l’environnement est dangereux, le contenu est principalement{" "}
          <strong>PvE</strong>. Les activités typiques incluent la{" "}
          <strong>capture d’avant-postes</strong>, le{" "}
          <strong>farm de réputation/fame en static</strong>, et parfois des{" "}
          <strong>compos bombes</strong> bien organisées.
        </p>
        <p>
          Les avantages de Caerleon ? Aucun "pisslow" en stuff pourri. Si tu
          sais jouer et que tu t’organises bien,{" "}
          <strong>il est tout à fait possible de ne jamais mourir</strong>. En
          plus, c’est extrêmement rentable et honnêtement, c’est stylé.
        </p>
        <p>
          Les désavantages de Caerleon ? Tu ne peux plus vraiment gather en zone
          safe en étant factionné, tu es obligé de t'organiser pour faire de la
          faction, tu ne peux plus jouer avec les collègues de Bridgewatch.
        </p>
      </div>
    ),
  },
      ...
      <>
        <div className="bg-[#656874] rounded-lg p-4 mb-4">
          ...
          <ul className="list-inside text-[#ffeff8] mt-2">
            ...
            <li>
              🐎 <strong>Utilisez une monture rapide</strong> – Cerf, cheval T5
              ou vivegriffe au minimum pour fuir ou poursuivre efficacement.
            </li>
            <li>
              👥 <strong>Restez groupé mais pas collé</strong> – Évitez les AoE
              et facilitez vos déplacements en équipe.
            </li>
            <li>
              🎯 <strong>Focus une seule cible en combat</strong> – En général,
              éliminez le healer en premier !
            </li>
            <li>
              👀 <strong>Attention aux blobs et gros groupes</strong> – Un zerg
              peut vite vous écraser si vous ne faites pas attention.
            </li>
            <li>
            ...
            <li>
              ...
              soyez tank, DPS ou healer, maîtrisez votre rôle pour une meilleure
              synergie d'équipe.
            </li>
            <li>
              🗺️ <strong>Familiarisez-vous avec les zones PvP</strong> –
              Apprenez les particularités des zones rouges et noires pour
              anticiper les dangers et opportunités. Apprenez également à duels
              en corrompus ou à fuir en mists (ce ne sont que des exemples).
            </li>
            <li>
            ...
            <li>
              ...
              peuvent se cacher dans les recoins, soyez toujours sur vos gardes.
            </li>
            <li>
              💀 <strong>Apprenez des défaites</strong> – Analysez chaque combat
              perdu pour identifier vos erreurs et vous améliorer.
            </li>
            <li>
      ...
      <>
        <>
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <ul className="list-inside text-[#ffeff8] mt-2">
              <li>
                <strong>Noms sans tiret</strong> (ex : Eldon Hill) mènent à des
                maps normales.
              </li>
              <li>
                <strong>Noms avec un tiret</strong> (ex : Xasos-Aeoilos) mènent
                à une map avalonienne classique.
              </li>
              <li>
        ...
        <>
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <p className="text-[#ffeff8] mt-2">
              ...
              entrée sous forme de portail. On peut les trouver avec les petites
              fées/petits feu follets disponibles un peu partout sur la map.
              Elles offrent des mobs à tuer, quelques petits lacs pour pêcher,
              des coffres aléatoires, etc. Tous les types de ressources y sont
              disponibles.
            </p>
            <div className="flex justify-center items-center">
              <img
          ...
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            <h3 className="text-lg text-[#ffeff8]">Réputation de Brecilien</h3>
            <p className="text-[#ffeff8] mt-2">
              Les Brumes ont une réputation similaire aux Factions, appelée
              Réputation de Brecillen. Vous pouvez augmenter votre réputation en
              accomplissant deux tâches : sauver des Wisps et nettoyer des
              Camps. Vous pouvez vérifier votre niveau de réputation en ouvrant
              vos Statistiques et en faisant défiler jusqu'en bas. Vous
              commencez comme "Neutre", c'est-à-dire à 0. Vous débloquerez le
              rang "Amical" à 50 000 points de réputation, et vous débloquerez
              ainsi l'accès à Brecilien (via un nouveau portail dans les
              brumes).
            </p>
          </div>
          ...
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <p className="text-[#ffeff8] mt-2">
              Dans les Brumes, écoutez un "sifflement plaintif" pour trouver des
              Wisps piégés. Interagissez avec le Wisp piégé pour le libérer,
              mais cela prend du temps, il est donc généralement préférable de
              tuer les mobs autour. Cependant, vous pouvez également voler des
              Wisps aux autres joueurs en les sauvant pendant qu'ils combattent
              les mobs.
            </p>
            <div className="flex justify-center items-center">
              <img
          ...
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <p className="text-[#ffeff8] mt-2">
              ...
              qui réapparaissent constamment, comme dans les Donjons Statiques.
              Votre objectif est de tuer suffisamment de mobs pour obtenir la
              renommée requise : 2.7K pour les petits camps, 5K pour les camps
              moyens et 10K pour les grands camps. D'autres joueurs rivaliseront
              pour nettoyer les camps, alors agissez rapidement, surtout en Zone
              Rouge et Noire. Les zones de ressources/camps des brumes sont
              toujours sur le même pattern, mais sont rotatées aléatoirement sur
              360°.
            </p>
            <div className="flex justify-center items-center">
              <img
          ...
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <ul className="list-inside text-[#ffeff8] mt-2">
              <li>
                <strong>Tier de Ressources :</strong> Les Brumes de plus grande
                rareté contiennent des ressources de plus haut niveau.
              </li>
              <li>
              ...
              <li>
                ...
                renommée requise pour nettoyer les camps varie en fonction de la
                rareté des Brumes.
              </li>
              <li>
                <strong>Récompenses :</strong> Les Brumes de plus grande rareté
                offrent de meilleures récompenses, y compris un butin plus
                précieux et des gains de réputation plus élevés.
              </li>
            </ul>
            <div className="flex justify-center items-center">
              <img
          ...
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <p className="text-[#ffeff8] mt-2">
              ...
              débloquer des récompenses. Chaque salle nettoyée offre soit de la
              richesse via un coffre, soit un buff pour aider au combat. Étant
              dans les Brumes, vous avez un temps limité pour nettoyer les
              salles, accumuler des richesses et vaincre les ennemis. Des
              trésors et des coffres apparaissent pendant la durée de vie du
              donjon, offrant des opportunités de combat. Des sorties sont
              disponibles tout au long du donjon, vous permettant de trouver des
              trésors et de vous échapper si vous êtes engagé par un autre
              joueur. Quitter par une sortie vous ramène dans les Brumes, prêt à
          ...
          <div className="bg-[#656874] rounded-lg p-4 mb-4">
            ...
            <p className="text-[#ffeff8] mt-2">
              ...
              d'équipement. Dans les zones rouges et noires, les brumes vont du
              niveau 6 au niveau 8. Elles sont létales, alors soyez prudents.
            </p>
            <p className="text-[#ffeff8] mt-2">
            ...
            <p className="text-[#ffeff8] mt-2">
              Ces niveaux restent les mêmes pour les brumes non létales, mais un
              niveau inférieur.
            </p>
            <p className="text-[#ffeff8] mt-2">
              Les araignées de cristal et d'autres boss peuvent apparaître comme
              des ennemis de niveau 5 à niveau 8 dans les brumes. Les araignées
              de cristal sont agressives mais n'attaquent que si elles sont
              provoquées. Elles fournissent de la puissance et des faveurs à
              leur mort. Les araignées de cristal laissent tomber des runes, des
              âmes, des reliques, des artefacts, des cartes de donjon et des
              sacs d'argent. Ces boss légendaires, hors l'araignée de cristal,
              n'apparaissent que dans des mists enchantées.
            </p>
          </div>
        </>
      </>
